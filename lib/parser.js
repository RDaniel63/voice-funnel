...
RESPOND WITH VALID JSON ONLY. No markdown, no explanation. Return a JSON object with an "items" array. Each distinct task, idea, or action MUST be its own separate item — never combine multiple actions into one item.

Example format:
{"items": [
  {
    "text": "Clear action statement for first task",
  ...
  {
    "text": "Clear action statement for second task",
    "original_transcript": "The exact words that generated this item",
    "status": "not_started",
    "priority_level": 2,
    "tags": ["task"],
